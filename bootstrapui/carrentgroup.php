...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 ...
 <div class="col-md-12">
          ...
          <div class="panel-heading dropdown">
            Sales <img src="http://localhost/seimspeedold/public/imgs/land_sales.png" style="height:40px;width:auto"> 
          </div>
          <div class="panel-body" style="padding:0;margin:0">
            <div class="list-group" style="margin-bottom:0">
              <a href="http://localhost/seimspeedold/public/corporate/1/cars/sales" class="list-group-item" style="border-radius:0">Cars available for Rent <span class="label label-primary pull-right">
                 
                  4
                              </span></a>
              <a href="http://localhost/seimspeedold/public/corporate/1/cars/reserves" class="list-group-item" style="border-radius:0">Cars currently Reserved <span class="label label-primary pull-right">
                                  0
                              </span></a>
            </div> 
            <h4 style="padding:10px;">Rental Car Groups</h4>
            <table class="table table-bordered table-hover" style="margin-bottom:0"> 
              <tbody> 
                                  <tr> 
                    <td>repellendus</td> 
                    <td style="font-size:11px;color:grey">7 months ago</td> 
                    <td style="font-size:15px;"><a href="#"><span class="label label-primary">view</span></a></td>
                  </tr> 
                                  <tr> 
                    <td>corporis</td> 
                    <td style="font-size:11px;color:grey">7 months ago</td> 
