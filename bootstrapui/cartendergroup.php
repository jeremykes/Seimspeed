 ...
 <div class="col-md-12">
          ...
          <div class="panel-body" style="padding:0;margin:0">
            <div class="list-group" style="margin-bottom:0">
              <a href="http://localhost/seimspeedold/public/corporate/1/cars/sales" class="list-group-item" style="border-radius:0">Cars available or Tender <span class="label label-primary pull-right">
