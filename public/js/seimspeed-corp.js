...
// Reserve Offer ============
function reserveCarSaleOffer(offerID) {
    $.ajax({
        url: base_url + "/corporate/" + corporateID + "/corpuser/sales/car/saleofferreserve",
        type: "POST",
        data: { 
            'carsaleoffer_id': offerID
        },
        success: function(data) {
            // Event takes care of action
        }
    });
}

function reserveCarRentOffer(offerID) {
    $.ajax({
        url: base_url + "/corporate/" + corporateID + "/corpuser/rents/car/rentofferreserve",
        type: "POST",
        data: { 
            'carrentoffer_id': offerID
        },
        success: function(data) {
            // Event takes care of action
        }
...
function reserveCarTenderOffer(tenderID) {
    $.ajax({
        url: base_url + "/corporate/" + corporateID + "/corpuser/tenders/car/tendertenderreserve",
        type: "POST",
        data: { 
            'cartendertender_id': tenderID
        },
        success: function(data) {
            // Event takes care of action
        }
...
function reserveCarAuctionOffer(bidID) {
    $.ajax({
        url: base_url + "/corporate/" + corporateID + "/corpuser/auctions/car/auctionbidreserve",
        type: "POST",
        data: { 
            'carauctionbid_id': bidID
        },
        success: function(data) {
            // Event takes care of action
        }
...
function cancelReserveCarSaleOffer(offerID) {
    $.ajax({
...
function cancelReserveCarRentOffer(offerID) {
    $.ajax({
        url: base_url + "/corporate/" + corporateID + "/corpuser/rents/car/rentofferreservecancel",
        type: "POST",
        data: { 
            'carrentoffer_id': offerID
        },
...
function cancelReserveCarTenderOffer(tenderID) {
    $.ajax({
        url: base_url + "/corporate/" + corporateID + "/corpuser/tenders/car/tendertenderreservecancel",
        type: "POST",
        data: { 
            'cartendertender_id': tenderID
        },
...
function cancelReserveCarAuctionOffer(bidID) {
    $.ajax({
        url: base_url + "/corporate/" + corporateID + "/corpuser/auctions/car/auctionbidreservecancel",
        type: "POST",
        data: { 
            'carauctionbid_id': bidID
        },
...
function cancelReservePartSaleOffer(offerID) {
    $.ajax({
...
// Purchase Reserve Offer and Forms ======
function purchaseReserveCarSaleOfferForm(reserveID) {
    $('#carsalereserve_id').val(reserveID);
    $('#salePurchaseModal').modal('show');
}

function purchaseReserveCarSaleOffer(reserveID) {
    $.ajax({
        url: base_url + "/corporate/" + corporateID + "/corpuser/sales/car/purchasesale",
        type: "POST",
        data: { 
            'carsalereserve_id': reserveID
        },
        success: function(data) {
            // Event takes care of action
        }
...
function purchaseReserveCarRentOfferForm(reserveID) {
    $('#carrentreserve_id').val(reserveID);
    $('#rentPurchaseModal').modal('show');
}

function purchaseReserveCarRentOffer(reserveID) {
    $.ajax({
        url: base_url + "/corporate/" + corporateID + "/corpuser/rents/car/purchaserent",
        type: "POST",
        data: { 
            'carrentreserve_id': reserveID
        },
        success: function(data) {
            // Event takes care of action
        }
...
function purchaseReserveCarTenderTenderForm(reserveID) {
    $('#cartenderreserve_id').val(reserveID);
    $('#tenderPurchaseModal').modal('show');
}

function purchaseReserveCarTenderTender(reserveID) {
    $.ajax({
        url: base_url + "/corporate/" + corporateID + "/corpuser/tenders/car/purchasetender",
        type: "POST",
        data: { 
            'cartenderreserve_id': reserveID
        },
        success: function(data) {
            // Event takes care of action
        }
...
function purchaseReserveCarAuctionBidForm(reserveID) {
    $('#carauctionreserve_id').val(reserveID);
    $('#auctionPurchaseModal').modal('show');
}

function purchaseReserveCarAuctionBid(reserveID) {
    $.ajax({
        url: base_url + "/corporate/" + corporateID + "/corpuser/auctions/car/purchaseauction",
        type: "POST",
        data: { 
            'carauctionreserve_id': reserveID
        },
        success: function(data) {
            // Event takes care of action
        }
...
function purchaseReservePartSaleOfferForm(reserveID) {
    $('#partsalereserve_id').val(reserveID);
    $('#salePurchaseModal').modal('show');
}

function purchaseReservePartSaleOffer(reserveID) {
    $.ajax({
        url: base_url + "/corporate/" + corporateID + "/corpuser/sales/part/purchasesale",
        type: "POST",
        data: { 
            'partsalereserve_id': reserveID
        },
        success: function(data) {
            // Event takes care of action
        }
...
function CarCommentAddedBuildTrade(data) {
    ...
    htmltext += '    </p>';
    htmltext += '    <p>';
    htmltext += '    <p><a class="pull-right" href="javascript:void(0);" onclick="deleteCarComment(' + data.car_id + ',' + data.id + ')">delete</a></p>';
    htmltext += '    </p>';
    htmltext += '    <br>';
    htmltext += '    <br>';
...
function PartCommentAddedBuildTrade(data) {
    ...
    htmltext += '    </p>';
    htmltext += '    <p>';
    htmltext += '    <p><a class="pull-right" href="javascript:void(0);" onclick="deletePartComment(' + data.part_id + ',' + data.id + ')">delete</a></p>';
    htmltext += '    </p>';
    htmltext += '    <br>';
    htmltext += '    <br>';
    htmltext += '    <br>';
            ...
            if (data.success == true) {
                ...
                for (var i = 0; i < data.cartails.length; i++) {
                    ...
                    if (data.cartails[i].propic != null) {
                        ...
                        htmltext += '    <img class="img-responsive" src="' + base_url + '/imgs/no-images.png" style="height:50px;width:auto"> ';
                    }
