        ...
        <div class="col-md-7">
          ...
          <div class="panel panel-primary">
            <div class="panel-body" style="border-radius:0">
              <div class="col-md-4">
                <img class="img-responsive" src="imgs/a.png">
              </div>
              <div class="col-md-8">
                <p><strong>Lands Department</strong> <span class="pull-right" style="font-size:10px;color:gray">3 days ago&nbsp;&nbsp;<span class="label label-warning" style="font-size:15px">auction</span></span></p>
...
the directive is used to display the contents of a given section.</p>
                <p><span style="color:gray;font-size:11px">2 comments <i class="fa fa-comment-o"></i></span>&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:gray;font-size:11px">11 bids <i class="fa fa-money"></i></span>&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:gray;font-size:11px">630 tailing <i class="fa fa-eye"></i></span></p>
                <p><span style="color:rgb(0,139,188)"><a href="#" style="text-decoration:underline;">comment</a>&nbsp;&nbsp;&nbsp;<a href="#" style="text-decoration:underline;">tail</a></span><span class="pull-right"><span style="font-size:9px;color:grey">last bid</span>&nbsp;&nbsp;<span class="label label-default" style="font-size:15px">K4,550</span><span></span></p>
              </div>
            </div>
          </div>
          ...
          <div class="panel panel-warning">
            <div class="panel-heading">
              <strong>Department of Works</strong><span class="pull-right">Auction Group</span>
            </div>
            <div class="panel-body" style="border-radius:0">
              <div class="col-md-4">
              ...
              <div class="col-md-8">
                <p><strong>Bi Annual Stock</strong><span class="pull-right" style="font-size:10px;color:gray">2 days ago</span></p>
                <p>First ever car for sale. The directive, as the name implies, defines a section of content, while
the directive is used to display the contents of a given section.</p>
