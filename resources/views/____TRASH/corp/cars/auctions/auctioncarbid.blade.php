          ...
          <div class="panel panel-primary" style="padding-bottom:0;margin-bottom:0;">
            <div class="panel-body">
              ...
              <div class="col-md-9">
                ...
                <p><strong>{{ $carauction->car->make }}</strong></p>
          ...
          <div class="list-group">
              ...
              <div class="col-md-12">
                <p>
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" aria-label="Your bid">
                    <span class="input-group-addon">.00</span>
                  </div>
                  <div class="input-group">
                    <br>
                    <a class="btn btn-success btn-xs">bid</a>
                  </div>
                </p>
              </div>
            </div>
            ...
            @foreach ($bids as $bid)
                ...
                <div class="list-group-item col-md-12">
                  ...
                  <div class="col-md-10">
                    <p><strong>{{ $bid->user->name }}</strong> <span class="pull-right"><span style="color:gray;font-size:11px">{{ $bid->created_at->diffForHumans() }}</span></span></p>
                    <p style="font-size:18px"><span class="label label-default">{{ $bid->bid }}</span></p>
                    <p class="pull-right">
                      <a style="font-size:9px" class="btn btn-xs btn-success">accept bid</a> 
                      <a style="font-size:9px" class="btn btn-xs btn-default">delete bid</a> 
