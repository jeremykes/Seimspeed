        ...
        <div class="col-md-7">
          ...
          <div class="panel panel-primary">
            <div class="panel-body" style="border-radius:0">
              ...
              <div class="col-md-8">
                <p><strong>Same Speed</strong> <span class="pull-right" style="font-size:10px;color:gray">2 days ago&nbsp;&nbsp;<span class="label label-danger" style="font-size:15px">sale</span></span></p>
                <p>First ever car part for sale. The directive, as the name implies, defines a section of content, while
the directive is used to display the contents of a given section.</p>
                ...
                <p><span style="color:rgb(0,139,188)"><a href="#" style="text-decoration:underline;">comment</a>&nbsp;&nbsp;&nbsp;<a href="#" style="text-decoration:underline;">tail</a></span><span class="pull-right"><span style="font-size:9px;color:grey">non-negotiable</span>&nbsp;&nbsp;<span class="label label-default" style="font-size:15px">K3,000</span></span></p>
              </div>
            </div>
          </div>
          ...
          <div class="panel panel-danger">
            <div class="panel-heading">
              <strong>Health Department</strong><span class="pull-right">Sale Group</span>
            </div>
            <div class="panel-body" style="border-radius:0">
              <div class="col-md-4">
                <img class="img-responsive" src="imgs/mycar.png">
              ...
              <div class="col-md-8">
                <p><strong>Yearly Part Asset Removal</strong><span class="pull-right" style="font-size:10px;color:gray">2 days ago</span></p>
                <p>First ever car part for sale. The directive, as the name implies, defines a section of content, while
the directive is used to display the contents of a given section.</p>
                <p><span style="color:gray;font-size:11px">7 comments <i class="fa fa-comment-o"></i></span>&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:gray;font-size:11px">23 offers <i class="fa fa-money"></i></span>&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:gray;font-size:11px">243 tailing <i class="fa fa-eye"></i></span></p>
