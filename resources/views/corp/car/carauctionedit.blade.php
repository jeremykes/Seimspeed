...
<div class="col-md-12">
    ...
    <form action="{{ url('/corporate/' . $corporate->id .'/corpuser/auctions/car/updateauction') }}" method="post">

        @include('common.errors')

        <!-- To send carID into controller if user selects one. FUTURE -->
        <input type="hidden" id="carauction_id" name="carauction_id" value="{{ $carauction->id }}">
        ...
        <div class="col-md-12">
            <h3>
                ...
                <span class="pull-right"><a href="javascript:void(0);" onclick="Are you sure you want to close this car auction?', 'closeCarAuction({{ $carauction->id }})', 'danger')" class="btn btn-xs btn-default"></a></span>
            </h3>
        </div>
        <div class="form-group col-md-6">
            <label for="webmenu">Body Type *</label>
            <select class="bodytypeselect" name="webmenu" id="webmenu" style="width:100%">
                @if ($carauction->car->bodytype == 'cargovan')
                ...
                @endif
                @if ($carauction->car->bodytype == 'coupe')
                ...
                @endif
                @if ($carauction->car->bodytype == 'hatchback')
                ...
                @endif
                @if ($carauction->car->bodytype == 'jeep')
                ...
                @endif
                @if ($carauction->car->bodytype == 'limousine')
                ...
                @endif
                @if ($carauction->car->bodytype == 'bus')
                ...
                @endif
                @if ($carauction->car->bodytype == 'pickup')
                ...
                @endif
                @if ($carauction->car->bodytype == 'sedan')
                ...
                @endif
                @if ($carauction->car->bodytype == 'suv')
                ...
                @endif
                @if ($carauction->car->bodytype == 'van')
                ...
                @endif
                @if ($carauction->car->bodytype == 'wagon')
                ...
                @endif
                @if ($carauction->car->bodytype == 'truck')
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control carmakeautocomplete" id="make" name="make" value="{{ $carauction->car->make }}">
            <span style="color:grey;font-size:10px">Toyota, Nassan, Porche, etc. Start typing to see hints.</span>
        </div>
        <div class="form-group col-md-6">
            <label for="model">Model *</label>
            <input type="text" class="form-control carmodelautocomplete" id="model" name="model" value="{{ $carauction->car->model }}">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="plates" name="plates" value="{{ $carauction->car->plates }}">
            <span style="color:grey;font-size:10px">&nbsp;</span>
        </div>
        <div class="form-group col-md-6">
            <label for="color">Color</label>
            <input type="text" class="form-control" id="color" name="color" value="{{ $carauction->car->color }}">
            <span style="color:grey;font-size:10px">&nbsp;</span>
        </div>
        <div class="form-group col-md-6">
            <label for="weight">Weight</label>
            <input type="text" class="form-control" id="weight" name="weight" value="{{ $carauction->car->weight }}">
            <span style="color:grey;font-size:10px">In tonnes</span>
        </div>
        <div class="form-group col-md-6">
            <label for="fueltype">Fuel Type</label>
            <select class="form-control" id="fueltype" name="fueltype">
                @if ($carauction->car->fueltype == 'diesel')
        ...
        <div class="form-group col-md-6">
            ...
            <select class="form-control" id="transmissiontype" name="transmissiontype" >
                @if ($carauction->car->fueltype == 'automatic')
        ...
        <div class="form-group col-md-6">
            ...
            <select class="form-control" id="drivetype" name="drivetype" >
                @if ($carauction->car->fueltype == '2 wheel drive')
        ...
        <div class="form-group col-md-6">
            ...
            <select class="form-control" id="steeringside" name="steeringside">
                @if ($carauction->car->fueltype == 'right')
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="physicallocation" name="physicallocation" value="{{ $carauction->car->physicallocation }}">
            <span style="color:grey;font-size:10px">&nbsp;</span>
        </div>
        <div class="form-group col-md-6">
            <label for="datebought">Date bought</label>
            <input type="text" class="form-control datepicker" id="datebought" name="datebought" value="{{ $carauction->car->datebought->format('d/m/Y') }}">
            <span style="color:grey;font-size:10px">day/month/year</span>
        </div>
        <div class="form-group col-md-12">
            <label for="carnote">Car note</label>
            <input type="text" class="form-control" id="carnote" name="carnote" value="{{ $carauction->car->note }}">
            <span style="color:grey;font-size:10px">&nbsp;</span>
        </div>
        ...
        <div class="col-md-12"><h3>Auction details</h3></div>
        <div class="form-group col-md-6">
            <label for="price">price</label>
            <input type="text" class="form-control" id="price" name="price" value="{{ $carauction->price }}">
            <span style="color:grey;font-size:10px">In Kina</span>
        </div>
        <div class="form-group col-md-6">
            <label for="negotiable">negotiable</label>
            <select class="form-control" id="negotiable" name="negotiable">
                @if ($carauction->negotiable == '1')
        ...
        <div class="form-group col-md-12">
            <label for="auctionnote">Auction note</label>
            <input type="text" class="form-control" id="auctionnote" name="auctionnote" value="{{ $carauction->note }}">
            <span style="color:grey;font-size:10px">&nbsp;</span>
        </div>
        <div class="form-group col-md-12">
    ...
    Dropzone.options.myAwesomeDropzone = {
          init: function() {
              ...
              this.on('removedfile', function(file, response) {
                  ...
                  $.ajax({
                      url: "{{ url('/corporate/' . $corporate->id . '/corpuser/auctions/car/cardeletetempimage') }}",
                      type: "POST",
                      data: { 
          ...
          url: "{{ url('/corporate/' . $corporate->id . '/corpuser/auctions/car/caruploadtempimage') }}",
          method: 'post',
