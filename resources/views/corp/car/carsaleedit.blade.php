...
<div class="col-md-12">
    ...
    <form action="{{ url('/corporate/' . $corporate->id .'/corpuser/sales/car/updatesale') }}" method="post">

        @include('common.errors')

        <!-- To send carID into controller if user selects one. FUTURE -->
        <input type="hidden" id="carsale_id" name="carsale_id" value="{{ $carsale->id }}">
        ...
        <div class="col-md-12">
            <h3>
                ...
                <span class="pull-right"><a href="javascript:void(0);" onclick="confirmMe('Are you sure you want to close this car sale?', 'closeCarSale({{ $carsale->id }})', 'danger')" class="btn btn-xs btn-default">close</a></span>
            </h3>
        </div>
        <div class="form-group col-md-6">
            <label for="webmenu">Body Type *</label>
            <select class="bodytypeselect" name="webmenu" id="webmenu" style="width:100%">
                @if ($carsale->car->bodytype == 'cargovan')
                ...
                @endif
                @if ($carsale->car->bodytype == 'hatchback')
                ...
                @endif
                @if ($carsale->car->bodytype == 'limousine')
                ...
                @endif
                @if ($carsale->car->bodytype == 'pickup')
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control carmakeautocomplete" id="make" name="make" value="{{ $carsale->car->make }}">
            <span style="color:grey;font-size:10px">Toyota, Nassan, Porche, etc. Start typing to see hints.</span>
        </div>
        <div class="form-group col-md-6">
            <label for="model">Model *</label>
            <input type="text" class="form-control carmodelautocomplete" id="model" name="model" value="{{ $carsale->car->model }}">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="plates" name="plates" value="{{ $carsale->car->plates }}">
            <span style="color:grey;font-size:10px">&nbsp;</span>
        </div>
        <div class="form-group col-md-6">
            <label for="color">Color</label>
            <input type="text" class="form-control" id="color" name="color" value="{{ $carsale->car->color }}">
            <span style="color:grey;font-size:10px">&nbsp;</span>
        </div>
        <div class="form-group col-md-6">
            <label for="weight">Weight</label>
            <input type="text" class="form-control" id="weight" name="weight" value="{{ $carsale->car->weight }}">
            <span style="color:grey;font-size:10px">In tonnes</span>
        </div>
        <div class="form-group col-md-6">
            <label for="fueltype">Fuel Type</label>
            <select class="form-control" id="fueltype" name="fueltype">
                @if ($carsale->car->fueltype == 'diesel')
        ...
        <div class="form-group col-md-6">
            ...
            <select class="form-control" id="transmissiontype" name="transmissiontype" >
                @if ($carsale->car->fueltype == 'automatic')
        ...
        <div class="form-group col-md-6">
            ...
            <select class="form-control" id="drivetype" name="drivetype" >
                @if ($carsale->car->fueltype == '2 wheel drive')
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="physicallocation" name="physicallocation" value="{{ $carsale->car->physicallocation }}">
            <span style="color:grey;font-size:10px">&nbsp;</span>
        </div>
        <div class="form-group col-md-6">
            <label for="datebought">Date bought</label>
            <input type="text" class="form-control datepicker" id="datebought" name="datebought" value="{{ $carsale->car->datebought->format('d/m/Y') }}">
            <span style="color:grey;font-size:10px">day/month/year</span>
        </div>
        <div class="form-group col-md-12">
            <label for="carnote">Car note</label>
            <input type="text" class="form-control" id="carnote" name="carnote" value="{{ $carsale->car->note }}">
            <span style="color:grey;font-size:10px">&nbsp;</span>
        </div>
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="price" name="price" value="{{ $carsale->price }}">
        ...
        <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" id="salenote" name="salenote" value="{{ $carsale->note }}">
            <span style="color:grey;font-size:10px">&nbsp;</span>
        </div>
        <div class="form-group col-md-12">
