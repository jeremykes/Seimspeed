...
<div class="col-md-12">
    ...
    <form action="{{ url('/corporate/' . $corporate->id .'/corpuser/tenders/car/addtender') }}" method="post">
        ...
        <input type="hidden" id="cartender_id" name="cartender_id" value="{{ $cartender->id }}">
        ...
        <div class="col-md-12">
            <h3>
                ...
                <span class="pull-right"><a href="javascript:void(0);" onclick="confirmMe('Are you sure you want to close this car tender?', 'closeCarTender({{ $cartender->id }})', 'danger')" class="btn btn-xs btn-default">close</a></span>
            </h3>
        </div>
        <div class="form-group col-md-6">
            <label for="webmenu">Body Type *</label>
            <select class="bodytypeselect" name="webmenu" id="webmenu" style="width:100%">
                @if ($cartender->car->bodytype == 'cargovan')
                ...
                @endif
                @if ($cartender->car->bodytype == 'coupe')
                ...
                @endif
                @if ($cartender->car->bodytype == 'hatchback')
                ...
                @endif
                @if ($cartender->car->bodytype == 'jeep')
                ...
                @endif
                @if ($cartender->car->bodytype == 'limousine')
                ...
                @endif
                @if ($cartender->car->bodytype == 'pickup')
                ...
                @endif
                @if ($cartender->car->bodytype == 'sedan')
                ...
                @endif
                @if ($cartender->car->bodytype == 'wagon')
                ...
                @endif
                @if ($cartender->car->bodytype == 'truck')
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control carmakeautocomplete" id="make" name="make" value="{{ $cartender->car->make }}">
            <span style="color:grey;font-size:10px">Toyota, Nassan, Porche, etc. Start typing to see hints.</span>
        </div>
        <div class="form-group col-md-6">
            <label for="model">Model *</label>
            <input type="text" class="form-control carmodelautocomplete" id="model" name="model" value="{{ $cartender->car->model }}">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="plates" name="plates" value="{{ $cartender->car->plates }}">
            <span style="color:grey;font-size:10px">&nbsp;</span>
        </div>
        <div class="form-group col-md-6">
            <label for="color">Color</label>
            <input type="text" class="form-control" id="color" name="color" value="{{ $cartender->car->color }}">
            <span style="color:grey;font-size:10px">&nbsp;</span>
        </div>
        <div class="form-group col-md-6">
            <label for="weight">Weight</label>
            <input type="text" class="form-control" id="weight" name="weight" value="{{ $cartender->car->weight }}">
            <span style="color:grey;font-size:10px">In tonnes</span>
        </div>
        <div class="form-group col-md-6">
            <label for="fueltype">Fuel Type</label>
            <select class="form-control" id="fueltype" name="fueltype">
                @if ($cartender->car->fueltype == 'diesel')
        ...
        <div class="form-group col-md-6">
            ...
            <select class="form-control" id="transmissiontype" name="transmissiontype" >
                @if ($cartender->car->fueltype == 'automatic')
        ...
        <div class="form-group col-md-6">
            ...
            <select class="form-control" id="drivetype" name="drivetype" >
                @if ($cartender->car->fueltype == '2 wheel drive')
        ...
        <div class="form-group col-md-6">
            ...
            <select class="form-control" id="steeringside" name="steeringside">
                @if ($cartender->car->fueltype == 'right')
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="physicallocation" name="physicallocation" value="{{ $cartender->car->physicallocation }}">
            <span style="color:grey;font-size:10px">&nbsp;</span>
        </div>
        <div class="form-group col-md-6">
            <label for="datebought">Date bought</label>
            <input type="text" class="form-control datepicker" id="datebought" name="datebought" value="{{ $cartender->car->datebought->format('d/m/Y') }}">
            <span style="color:grey;font-size:10px">day/month/year</span>
        </div>
        <div class="form-group col-md-12">
            <label for="carnote">Car note</label>
            <input type="text" class="form-control" id="carnote" name="carnote" value="{{ $cartender->car->note }}">
            <span style="color:grey;font-size:10px">&nbsp;</span>
        </div>
        ...
        <div class="col-md-12"><h3>Tender details</h3></div>
        <div class="form-group col-md-6">
            <label for="price">price</label>
            <input type="text" class="form-control" id="price" name="price" value="{{ $cartender->price }}">
            <span style="color:grey;font-size:10px">In Kina</span>
        </div>
        <div class="form-group col-md-6">
            <label for="negotiable">negotiable</label>
            <select class="form-control" id="negotiable" name="negotiable">
                @if ($cartender->negotiable == '1')
        ...
        <div class="form-group col-md-12">
            <label for="tendernote">Tender note</label>
            <input type="text" class="form-control" id="tendernote" name="tendernote" value="{{ $cartender->note }}">
            <span style="color:grey;font-size:10px">&nbsp;</span>
        </div>
        <div class="form-group col-md-12">
    ...
    Dropzone.options.myAwesomeDropzone = {
          init: function() {
              ...
              this.on('removedfile', function(file, response) {
                  ...
                  $.ajax({
                      url: "{{ url('/corporate/' . $corporate->id . '/corpuser/tenders/car/cardeletetempimage') }}",
                      type: "POST",
                      data: { 
          ...
          url: "{{ url('/corporate/' . $corporate->id . '/corpuser/tenders/car/caruploadtempimage') }}",
          method: 'post',
