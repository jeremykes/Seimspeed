...
<div class="col-md-12">
    ...
    <form action="{{ url('/corporate/' . $corporate->id .'/corpuser/sales/car/addauction') }}" method="post">
        ...
        <div class="form-group col-md-6">
            <label for="startbidprice">Start bid price</label>
            <input type="text" class="form-control" id="startbidprice" name="startbidprice" placeholder="Start bid price">
            <span style="color:grey;font-size:10px">In Kina</span>
        </div>
        <div class="form-group col-md-6">
            <label for="signuprequired">Sign-up required</label>
            <select class="form-control" id="signuprequired" name="signuprequired">
        ...
        <div class="form-group col-md-6">
            <label for="signupfee">Sign-up fee</label>
            <input type="text" class="form-control" id="signupfee" name="signupfee" placeholder="Sign-up fee">
            <span style="color:grey;font-size:10px">In Kina</span>
        </div>
        <div class="form-group col-md-12">
            <label for="auctionnote">Auction note</label>
            <input type="text" class="form-control" id="auctionnote" name="auctionnote" placeholder="Auction note">
            <span style="color:grey;font-size:10px">&nbsp;</span>
        </div>
        <div class="form-group col-md-12">
