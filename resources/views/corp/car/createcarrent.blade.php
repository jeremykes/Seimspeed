...
<div class="col-md-12">
    ...
    <form action="{{ url('/corporate/' . $corporate->id .'/corpuser/sales/car/addrent') }}" method="post">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="rateperday" name="rateperday" placeholder="Rate per day">
            <span style="color:grey;font-size:10px">In Kina</span>
        </div>
        <div class="form-group col-md-6">
            <label for="bondfee">Bond fee</label>
            <input type="text" class="form-control" id="bondfee" name="bondfee" placeholder="Bond fee">
            <span style="color:grey;font-size:10px">In Kina</span>
        </div>
        <div class="form-group col-md-12">
            <label for="rentnote">Rent note</label>
            <input type="text" class="form-control" id="rentnote" name="rentnote" placeholder="Rent note">
            <span style="color:grey;font-size:10px">&nbsp;</span>
        </div>
        <div class="form-group col-md-12">
