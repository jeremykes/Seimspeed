...
<div class="col-md-12">
    ...
    <form action="{{ url('/corporate/' . $corporate->id .'/corpuser/sales/car/addtender') }}" method="post">
        ...
        <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" id="tendernote" name="tendernote" placeholder="Tender note">
            <span style="color:grey;font-size:10px">&nbsp;</span>
        </div>
        <div class="form-group col-md-12">
