...
@section('corp-cars')
        ...
        <div class="col-md-12">
          ...
          <div class="panel-heading dropdown">
            Tenders <img src="/imgs/elections.png" style="height:40px;width:auto"> 
          </div>
              ...
              <tbody> 
                <tr> 
                  ...
                  <td>
                    ...
                    <p><span style="color:gray;font-size:11px">7 comments <i class="fa fa-comment-o"></i></span>&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:gray;font-size:11px">23 tenders <i class="fa fa-money"></i></span>&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:gray;font-size:11px">243 tailing <i class="fa fa-eye"></i></span></p>
                  </td> 
