        ...
        <div class="col-md-7">
          ...
          <div class="panel panel-primary">
            <div class="panel-body" style="border-radius:0">
              <div class="col-md-4">
                <img class="img-responsive" src="imgs/b.png">
              </div>
              <div class="col-md-8">
                <p><strong>Jane's Hire Car</strong> <span class="pull-right" style="font-size:10px;color:gray">5 days ago&nbsp;&nbsp;<span class="label label-info" style="font-size:15px">rental</span></span></p>
                <p>First ever car for rental. The directive, as the name implies, defines a section of content, while
the directive is used to display the contents of a given section.</p>
                <p><span style="color:gray;font-size:11px">2 comments <i class="fa fa-comment-o"></i></span>&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:gray;font-size:11px">358 tailing <i class="fa fa-eye"></i></span></p>
                <p><span style="color:rgb(0,139,188)"><a href="#" style="text-decoration:underline;">comment</a>&nbsp;&nbsp;&nbsp;<a href="#" style="text-decoration:underline;">tail</a></span><span class="pull-right"><span class="label label-default" style="font-size:15px">K550/day</span></span></p>
              </div>
            </div>
          </div>
          ...
          <div class="panel panel-info">
            <div class="panel-heading">
              <strong>Hertz</strong><span class="pull-right">Rental Group</span>
            </div>
            <div class="panel-body" style="border-radius:0">
              <div class="col-md-4">
                <img class="img-responsive" src="imgs/b.png">
              ...
              <div class="col-md-8">
                <p><strong>New 4x4 Fleet</strong> <span class="pull-right" style="font-size:10px;color:gray">5 days ago</span></p>
                <p>First ever car for rental. The directive, as the name implies, defines a section of content, while
the directive is used to display the contents of a given section.</p>
                <p><span style="color:gray;font-size:11px">2 comments <i class="fa fa-comment-o"></i></span>&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:gray;font-size:11px">358 tailing <i class="fa fa-eye"></i></span></p>
