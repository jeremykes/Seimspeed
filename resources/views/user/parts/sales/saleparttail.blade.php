          ...
          <div class="list-group" style="padding-top:0;margin-top:0">
            <div class="list-group-item col-md-12">
              <div class="col-md-12" style="padding:10px;">
                <img src="/imgs/mycar.png" style="height:50px;width:auto"> <strong>Aya Stark</strong> <span class="pull-right"><span style="color:gray;font-size:11px">2 minutes ago</span></span>
              </div>
            </div>
            <div class="list-group-item col-md-12">
              <div class="col-md-12" style="padding:10px;">
