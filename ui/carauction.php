...
the directive is used to display the contents of a given section.</p>
                ...
                <p><span style="color:gray;font-size:11px">2 <i class="fa fa-comment-o"></i></span>&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:gray;font-size:11px">11 <i class="fa fa-money"></i></span>&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:gray;font-size:11px">630 <i class="fa fa-eye"></i></span></p>
