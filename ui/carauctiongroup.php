...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title>Car Auction Groups</title>
 ...
 <div class="col-md-12">
          ...
          <div class="panel-body" style="padding:0;margin:0">
            <div class="list-group" style="margin-bottom:0">
              <a href="http://localhost/seimspeedold/public/corporate/1/cars/sales" class="list-group-item" style="border-radius:0">Current Auctions <span class="label label-primary pull-right">
